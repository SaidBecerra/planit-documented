...
class RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _onPhoneVerification(BuildContext context) {
    Navigator.push(
        context, MaterialPageRoute(builder: (ctx) => ConfirmationScreen(phoneNumber: _phoneNumberController.text)));
  }
        ...
        child: Column(
          ...
          children: [
            ...
            TextInput(
              ...
              textInputType: TextInputType.phone, hintText: 'Ex: 5147714587'),
            SizedBox(
              height: 15,
            ),
